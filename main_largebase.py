...
from model_utils.modeling_llama import LlamaForCausalLM, LlamaDecoderLayer, LlamaAttention
...
MODEL_SIZE = '1b'
PROJECT_NAME = f'llama_{MODEL_SIZE}'
RUN_NAME = f'pretraining_mobillama_{MODEL_SIZE}_{DATE}'
